...
namespace MyENA\RGW\Chain\Metadata\Bucket;
...
use MyENA\RGW\Models\MetadataBucketResponse;
...
class Info extends AbstractLink implements MethodLink, ParameterLink, ExecutableLink
{
    ...
    /**
     * @return array(
     * @type \MyENA\RGW\Models\MetadataBucketResponse|null
    ...
    public function execute(): array
    {
        ...
        return MetadataBucketResponse::fromPSR7Response($resp);
    }
}